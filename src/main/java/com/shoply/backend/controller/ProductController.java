...
public class ProductController {
    ...
    @Operation(summary = "Add Product", description = "Create a new product within a specific category. Admin or Seller access required.")
    ...
    @Operation(summary = "Update Product", description = "Update details of an existing product by its ID. Admin or Seller access required.")
    ...
    @Operation(summary = "Delete Product", description = "Remove a product from the catalog by its ID. Admin or Seller access required.")
    ...
    @Operation(summary = "Get My Products", description = "Retrieve all products owned by the currently authenticated seller.")
    @GetMapping("/products/seller/me")
    public ResponseEntity<ProductResponse> getMyProducts(
        ...
        ProductResponse productResponse = productService.getAllProductsBySeller(pageNumber, pageSize, sortBy, sortOrder);
        return new ResponseEntity<>(productResponse, HttpStatus.OK);
    }
}
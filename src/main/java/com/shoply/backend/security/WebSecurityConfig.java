...
public class WebSecurityConfig {
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        // Assigns the custom user details service for authentication.
        authProvider.setUserDetailsService(userDetailsService);

        // Uses BCrypt password encoding to securely store and verify passwords.
    ...
    // This is an interface in Spring Boot that allows you to execute code after the Spring Boot application has started. It's often used for tasks like:
    // Initializing data in a database, Running setup logic, Executing scripts at application startup.
    @Bean
